...
// Library" per item (same dual-path pattern as ProductMediaEditor), plus
// plain up/down move buttons. No video/poster/caption fields — ServiceImage
// only ever models {src, alt, mediaAssetId?}, unlike Product's Media type.
